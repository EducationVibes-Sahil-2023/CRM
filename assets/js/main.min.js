...
$("body").on("loaded.bs.select change", "select.ajax-search", function (e) {
    ...
    if ((table_leads = $("table.table-leads")).length) {
        ...
        0 < c.length && (p.push(c.index()), _.push(c.index())), _table_api = initDataTable(table_leads, admin_url + "leads/table", _, p, r, [1, "desc"]), _table_api && 0 < c.length && _table_api.on("draw", function () {
    ...
    if ($("body").on("change", 'input[name="contacted_today"]', function () {
        ...
        $(".bulk_actions").on("change", 'input[name="mass_delete"]', function () { var e = $("#bulk_change"); $("#re-assignation_div").hide(), !0 === $(this).prop("checked") ? ($('input[name="mass_re-assignation"]').prop("checked", !1), e.find("select").selectpicker("val", ""), e.hide()) : e.show(), $(".mass_delete_separator").toggleClass("hide") }), $('input[name="mass_re-assignation"]').click(function () { var e = $("#bulk_change"); !0 === $(this).prop("checked") ? ($('input[name="mass_delete"]').prop("checked", !1), e.find("select").selectpicker("val", ""), e.hide(), $("#re-assignation_div").show()) : ($("#re-assignation_div").find("select").selectpicker("val", ""), $("#re-assignation_div").hide(), e.show()), $(".mass_delete_separator").toggleClass("hide") }),
