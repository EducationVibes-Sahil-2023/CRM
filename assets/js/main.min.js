...
function send_whatsapp_message(id) {
    ...
    // Secret key (this should be kept secure and not exposed in client-side code)
    const secretKey = 'EducationVibes@2024'; // Replace with your actual secret key
