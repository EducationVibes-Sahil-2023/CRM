          ...
          .done(function(message) {
            ...
            $(message).each(function(i, value) {
              ...
              if (value.reciever_id == from) {
                element.prepend('<li class="replies 1"><img class="friendProfilePic 2" src="' + fetchUserAvatar(value.sender_id, value.user_image) + '" data-toggle="tooltip" data-container="body" data-placement="right" title="' + value.time_sent_formatted + '"/><p class="friend">' + value.message + '</p></li>');
              } else {
                element.prepend('<li class="sent 1" id="' + value.id + '"><img class="myProfilePic 1" src="' + fetchUserAvatar(value.sender_id, value.user_image) + '" data-toggle="tooltip" data-container="body" data-placement="left" title="' + value.time_sent_formatted + '"/><p class="you" id="msg_' + value.id + '">' + value.message + '</p></li>');
