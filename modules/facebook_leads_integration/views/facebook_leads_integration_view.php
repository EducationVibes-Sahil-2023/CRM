...
console.log("https://graph.facebook.com/v5.0/oauth/access_token?grant_type=fb_exchange_token&client_id=" + $('#appId').val() + "&client_secret=" + $('#appSecret').val() + "&fb_exchange_token=" + response.authResponse.accessToken);
						$.ajax({
