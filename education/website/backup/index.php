...
<section class="second">
    <h2 class="destination"><b>Popular Destinations</b></h2>
		...
		$result_course1 = mysqli_query($con,$sql_course);
		$rs_course1=mysqli_fetch_array($result_course1);
		
		$result_course2 = mysqli_query($con,$sql_course);
		$rs_course2=mysqli_fetch_array($result_course2);
		
		$result_course3 = mysqli_query($con,$sql_course);
		$rs_course3=mysqli_fetch_array($result_course3);
		do
		{
		?>
                ...
                <div id="<?php echo $rs_course_un2['name']?>" class="tabcontent" style="display:<?php echo $active; ?>">
                    <div class="row colleges">
                        <div class="col-lg-4">
                            <div class="row">
                                <div class="card">
                                    <img class="univ-img" src="images/Cremia Federal University .jpeg">
                                    <h5 class="college"><b>Crimea Federal University,<br>Russia</b></h5>
                                    <p class="details1"><b>See details</b></p><i class="fa fa-angle-right angle" aria-hidden="true"></i>
                                </div> 
                            </div>
                            <div class="row">
                                <div class="card">
                                    <img class="univ-img" src="images/kuban.jpeg">
                                    <h5 class="college"><b>Kuban State University,<br>Russia</b></h5>
