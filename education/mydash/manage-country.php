...
include "includes/connection.php";
		...
		$paging_query = "SELECT * FROM country order by id";
		$paging_limit = 25;
...
<html>
  <head>
    ...
    <title><?php echo $tag; ?> | Manage Country</title>
...
{
	var i
		i=confirm('Country will be deleted. Please confirm.');
          
		  //alert(query);
		if(i)
		{
			//submitForm(query);
          document.form1.action="delete_records.php?"+query+"&form_no=3";
        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header with-border">
			  ...
			  <div style="text-align:right"><a href="add-country.php" class="btn btn-default btn-flat" title="Add New Country">Add New Country</a></div>
            </div>
			...
			{
			?>
			<p>Country has been deleted successfully.</p>
			<?php
			}
			else{
				...
				{
				?>
				<p>Country has been added successfully.</p>
				<?php
				}
				elseif(isset($_REQUEST['mesg'])&& $_REQUEST['mesg']==2)
				{
				?>
				<p>Country  has been updated  successfully.</p>
				<?php	
				}
			...
			?>
              <table  class="table table-bordered table-striped">
				...
				$rs_course = mysqli_fetch_array($result_course);
					...
					$sql2 = "SELECT * FROM university where country_id = '".$rs['id']."'";
				...
				?>
						...
						<td><a href="add-country.php?id=<?php echo base64_encode(serialize ($rs['id']));?>" title="edit"><img src="dist/img/edit.png" alt="edit"></a>
