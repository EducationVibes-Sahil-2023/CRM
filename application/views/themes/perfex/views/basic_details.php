...
<body>
			...
			<div class="col-lg-12">
				<div class="card">
					...
					<div class="row">
						...
						<div class="col-lg-3">
							<div class="form-group">
								<label for="exampleInputFirstName">First Name <span class="text-danger">*</span></label>
								<input class="form-control" type="text" required class="form-group" placeholder="First Name" name="first_name" id="first_name" value='<?php echo (isset($basicdetails)) ? $basicdetails->first_name : $contact->firstname; ?>'>
							</div>
						</div>
						<div class="col-lg-3">
							<div class="form-group">
						...
						<div class="col-lg-3">
							<div class="form-group">
								...
								<input class="form-control" type="text" required class="form-group" placeholder="Email Address" name="email" value='<?php echo (isset($basicdetails)) ? $basicdetails->email : $contact->email; ?>' readonly>
							</div>
						</div>
						<div class="col-lg-3">
							<div class="form-group">
								<label for="exampleInputMobileNumber">Mobile Number <span class="text-danger">*</span></label>
								<input class="form-control" type="text" required class="form-group" placeholder="Mobile Number" name="mobile" value='<?php echo (isset($basicdetails)) ? $basicdetails->mobile : $contact->phonenumber; ?>' readonly>
							</div>
						</div>
						<div class="col-lg-2">
							<div class="form-group">
								<label for="exampleInputDateOfBirth">Date Of Birth <span class="text-danger">*</span></label>
								<input type="date" class="form-control" required name="dob" value='<?php echo ($basicdetails->dob != '') ? $basicdetails->dob : ''; ?>' required="required">
						...
						<div class="col-lg-2">
							<div class="form-group">
								...
								<select class="form-control" name="gender" required id="gender" required>
						...
						<div class="col-lg-2">
							<div class="form-group">
								<label for="exampleInputPassword1">Passport <span class="text-danger">*</span></label>
								<select class="form-control" name="passport" required id="passport" onchange="select_passport(this.value)" required>
									<option value="">Select</option>
									<option <?php echo ($basicdetails->passport == 'Yes') ? 'selected' : ''; ?>>Yes</option>
									<option <?php echo ($basicdetails->passport == 'No') ? 'selected' : ''; ?>>No</option>
								</select>
								<?php echo form_error('passport'); ?>

							</div>
						</div>
						<div class="col-lg-3 passport-number-div <?= strtolower($basicdetails->passport) == 'yes' ? '' : 'hide' ?>">
							<div class="form-group">
								<label for="exampleInputPassword1">Passport Number <span class="text-danger">*</span></label>
								<input class="form-control" type="text" class="form-group" placeholder="Passport Number" name="passport_number" value='<?php echo (isset($basicdetails)) ? $basicdetails->passport_number : $contact->passport_number; ?>'>
							</div>
						</div>
					...
					<h4>Parent Details <span class="text-danger danger small">Provide details for either the father or the mother; one is mandatory.</span>
					</h4>
					<div class="row">
						<div class="col-lg-4">
							<div class="form-group">
						...
						<div class="col-lg-4">
							<div class="form-group">
								<label for="exampleInputPassword1">Mother Name <span class="text-danger">*</span></label>
	...
	<script>
		function select_passport(value) {
			$(".passport-number-div input").val("");
			if (value.toLowerCase() == "yes") {
				$(".passport-number-div").removeClass("hide");
				$(".passport-number-div input").attr("required", true);
			} else {
				$(".passport-number-div").addClass("hide");
				$(".passport-number-div input").removeAttr("required");
			}
		}
