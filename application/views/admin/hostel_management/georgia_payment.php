...
<script>
    function getPayementInformation(hostel_info_id) {
        ...
        if ($container.is(":visible")) {
            ...
            $.ajax({
                url: admin_url + "hostel_management/payment_information/georgia", // CI controller method
                type: "POST",
                data: {
...
?>
    ...
    <script>
        ...
        $(function() {
            ...
            if (quotation_id != "") {
                let hostelId = hostel_quotations[quotation_id].hostel;
                get_hostel_rentInfo(hostelId);
            }
        });
