            ...
            ?>
                <fieldset id="<?= !empty($track["show_div_name"]) ? $track["show_div_name"] : '12' ?>" style="display:<?= ($applicant_status == $k) ? "show" : "none" ?>">
                    ...
                    <?php
                        ...
                        if (!has_permission('application_tracker_mbbbs_sc', '', 'edit')) {

                            echo ' <div class="col-md-12"><h5>You do not have permission to continue to the next step.</h5></div>';
                        } else {
                        ?>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <label class="form-check-label">
                                        ...
                                        <input type="checkbox"
                                            ...
                                            name="sc_100"
                                            <?= !has_permission('application_tracker_mbbbs_sc', '', 'edit') ? 'disabled' : '' ?>
