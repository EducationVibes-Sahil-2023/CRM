            ...
            <div class="col-md-12">
                <div class="nrc-wrapper">
                    ...
                    <div class="nrc-header">
                        ...
                        <div>
                            <h3 class="nrc-title">Fresh Criteria</h3>
                    ...
                    <div class="row nrc-grid">
                        ...
                        <div class="col-md-3 nrc-col">
                            <div class="nrc-card">
                                ...
                                <p class="nrc-value">MBBS Abroad</p>
                            </div>
                        </div>
                    ...
                    <div class="nrc-footer">
                        ...
                        <span>Only leads matching <strong>all conditions</strong> above will be considered for the Fresh cron process.</span>
                    </div>
...
if (selectedStaff.length === 0) {
    ...
    return false;
        ...
        var payload = {
            ...
            non_selected_staff: non_selectedStaff,
        };
