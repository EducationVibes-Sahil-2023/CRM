                     ...
                     <div role="tabpanel" class="tab-pane<?php if (!isset($form)) {
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              ...
                              $selected_staff = !empty($form->auto_assign) ? explode(",", $form->auto_assign) : [];
                              $selected_type = '';
                              foreach ($type as $t) {
                                 if (isset($form) && $form->lead_type == $t['id']) {
                                    $selected_type = $t['id'];
                                 }
                              }
                              ...
                              <?php echo render_select('lead_type', $type, array('id', 'name'), 'Lead Type', $selected_type); ?>
