...
if (typeof(element_view_source) != 'undefined' && element_view_source != null)
{
 ...
 view_source_options = Array.from(view_source_options).map(({ value }) => value);
}
if (typeof(element_view_status) != 'undefined' && element_view_status != null)
{
 ...
 view_status_options = Array.from(view_status_options).map(({ value }) => value);
}
if (typeof(element_view_assign) != 'undefined' && element_view_assign != null)
 ...
 view_assigned_options = Array.from(view_assigned_options).map(({ value }) => value);
   }
  ...
  /* var view_course = document.getElementById("view_course").value;
   ...
   data : {lead_type: $("#lead_type").val(), assigned: view_assigned_options,source:view_source_options,from_date: from_date, to_date:to_date, up_from_date: up_from_date, up_to_date: up_to_date, followup_from_date: followup_from_date, followup_to_date: followup_to_date, assign_from_date: assign_from_date, assign_to_date: assign_to_date,status:view_status_options},
      dataType: "JSON",  
      cache:false,
      success: 
         function(data){
