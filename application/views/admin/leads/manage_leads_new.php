...
<script>
    ...
    $(function() {
        ...
        var r = {
            ...
            show_update_counts: "[name='show_update_counts']",
        ...
        var table_leads_new = $('table.table-leads-new');
        initDataTable(table_leads_new, admin_url + "leads/table_new", p, _, r, [1, "desc"])
        ...
        function periodFilter() {
            ...
            table_leads_new.DataTable().ajax.reload(null, false).on('draw.dt', function() {
...
<script>
 var table_leads_new = $('table.table-leads-new');
    ...
    $(function() {
        ...
        initDataTable(table_leads_new, admin_url + "leads/table_new", p, _, r, [table_leads_new.find("th.date-created").index(), "desc"])
        initDataTable('.table-lead-transfer-table', admin_url + 'leads/table_lead_transfer/0/<?= (is_admin()) ? 'admin' : 'counsellor' ?>/1', 'undefined', 'undefined', 'undefined', [0, 'desc']);
...
<script>
  ...
  show_loader();
            ...
            xhr = $.ajax({
                type: "POST",
                url: admin_url + "leads/lead_summary_filter_neww",
                data: {
                    lead_type: view_lead_type_options,
                    assigned: view_assigned_options,
                    source: view_source_options,
                ...
                success: function(data) {
                    ...
                    if($("#updationCounter").html() == '' && data.update_count!=''){
                    $("#updationCounter").html(data.update_count);
                    $("#updationCounter_time").html(data.call_count);
                    }
                    if (data.max_count != undefined && parseInt(data.max_count) > 0) {
