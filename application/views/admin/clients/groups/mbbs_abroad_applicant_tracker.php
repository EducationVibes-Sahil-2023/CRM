                                            ...
                                            <div class="invitation-item card shadow-sm p-3 mb-3">
                                                <h4 class="university-name">
                                                    ...
                                                    <span class="pull-right">
                                                        <?php if (!empty($file_url) && $client_infomation->client_type == 1  && $admissionpreferences->session_intake >= SESSION_INTAKE && !empty($staff_list[get_staff_user_id()]["post_sales"])) { ?>
