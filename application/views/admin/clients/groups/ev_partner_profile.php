									...
									<div class="row">
										...
										<div class="col-lg-2">
											<div class="form-group">
												...
												<input class="form-control" type="text" onkeypress="return acceptText(this,'number')" name="payment_recevied_from" value="<?= !empty($client->payment_recevied_from) ? $client->payment_recevied_from : '' ?>">
											</div>
										</div>
