											...
											if (!empty($documents_type)) : ?>
												...
												?>
													<tr>
														...
														<td>
														                                                        <input type="file" <?= !empty($doc_files["disabled"] == 1) ? 'disabled' : '' ?> name="files[<?= $doc_id ?>]" value="<?= $file_url ?>" class="form-control" accept="<?= htmlspecialchars($accept, ENT_QUOTES, 'UTF-8') ?>" <?= $required_attr ?>>
									...
									<div class="row">
										...
										<div class="col-lg-2">
											<div class="form-group">
												...
												<input class="form-control" type="text" name="payment_recevied_from" value="<?= !empty($client->payment_recevied_from) ? $client->payment_recevied_from : '' ?>">
											</div>
										</div>
