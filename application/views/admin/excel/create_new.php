...
$orgDoc  = array_column(json_decode($excelInfo->org)??[],'sequence','column_id');
$updDoc  = array_column(json_decode($excelInfo->upd)??[],'sequence','column_id');
$apDoc  = array_column(json_decode($excelInfo->ap)??[],'sequence','column_id');
$vapDoc  = array_column(json_decode($excelInfo->vap)??[],'sequence','column_id');
...
?>
                ...
                <h3>Origninal Documents</h3>
                                   ...
                                   <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            {
                                                $index=0;
                                                foreach ($orignal_documents as $org)
                                                {
                                                    ?>
                                                    <tr>
                                                      <td><?=($index+1)?></td>  
                                                      <td><?=$org['name']?></td>
                                                        <td>
                                                            <div class="checkbox">
                                                                <input type="checkbox"
                                                                    name="original_doc_ids[<?php echo $org['id']; ?>]"
                                                                    value="org_<?php echo $org['id']; ?>"
                                                                    <?=!empty($orgDoc) && !empty($orgDoc[$org['id']]) ?'checked':''?>
                                                                   >
                                                                   <label></label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                               <input type="number" step="any" class="form-control"
                                                                id="org_sequence_column_<?php echo $org['id']; ?>"
                                                                name="org_sequence[<?php echo $org['id']; ?>]"
                                                                value="<?php echo !empty($orgDoc[$org['id']]) ? $orgDoc[$org['id']] : ''; ?>">
                                                        </td>
                                                    </tr>
                                                    <?php
                                                    $index++;
                ...
                <h3>Upload Documents</h3>
                                   <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            {
                                                $index=0;
                                                foreach ($upload_document as $org)
                                                {
                                                    ?>
                                                    <tr>
                                                      <td><?=($index+1)?></td>  
                                                      <td><?=$org['name']?></td>
                                                        <td>
                                                            <div class="checkbox">
                                                                <input type="checkbox"
                                                                    name="upd_doc_ids[<?php echo $org['id']; ?>]"
                                                                    value="upd_<?php echo $org['id']; ?>"
                                                                    <?=!empty($updDoc) && !empty($updDoc[$org['id']]) ?'checked':''?>
                                                                   >
                                                                   <label></label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                               <input type="number" step="any" class="form-control"
                                                                id="upd_sequence_column_<?php echo $org['id']; ?>"
                                                                name="upd_sequence[<?php echo $org['id']; ?>]"
                                                                value="<?php echo !empty($updDoc[$org['id']]) ? $updDoc[$org['id']] : ''; ?>">
                                                        </td>
                                                    </tr>
                                                    <?php
                                                    $index++;
                ...
                <h3>Apostile Documents</h3>
                                   <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            {
                                                $index=0;
                                                foreach ($apostille_documents as $org)
                                                {
                                                    ?>
                                                    <tr>
                                                      <td><?=($index+1)?></td>  
                                                      <td><?=$org['name']?></td>
                                                        <td>
                                                            <div class="checkbox">
                                                                <input type="checkbox"
                                                                    name="ap_doc_ids[<?php echo $org['id']; ?>]"
                                                                    value="<?php echo $org['id']; ?>"
                                                                    <?=!empty($apDoc) && !empty($apDoc[$org['id']]) ?'checked':''?>
                                                                   >
                                                                   <label></label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                               <input type="number" step="any" class="form-control"
                                                                id="ap_sequence_column_<?php echo $org['id']; ?>"
                                                                name="ap_sequence[<?php echo $org['id']; ?>]"
                                                                 value="<?php echo !empty($apDoc[$org['id']]) ? $apDoc[$org['id']] : ''; ?>">
                                                        </td>
                                                    </tr>
                                                    <?php
                                                    $index++;
                ...
                <h3>Visa Apostile Documents</h3>
                                   <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php 
                                            if(!empty($apostille_visa_apostile_documents))
                                            {
                                                $index=0;
                                                foreach ($apostille_visa_apostile_documents as $org)
                                                {
                                                    ?>
                                                    <tr>
                                                      <td><?=($index+1)?></td>  
                                                      <td><?=$org['name']?></td>
                                                        <td>
                                                            <div class="checkbox">
                                                                <input type="checkbox"
                                                                    name="visa_doc_ids[<?php echo $org['id']; ?>]"
                                                                    value="<?php echo $org['id']; ?>"
                                                                    <?=!empty($vapDoc) && !empty($vapDoc[$org['id']]) ?'checked':''?>
                                                                   >
                                                                   <label></label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                               <input type="number" step="any" class="form-control"
                                                                id="visa_sequence_column_<?php echo $org['id']; ?>"
                                                                name="visa_sequence[<?php echo $org['id']; ?>]"
                                                                value="<?php echo !empty($vapDoc[$org['id']]) ? $vapDoc[$org['id']] : ''; ?>">
                                                        </td>
                                                    </tr>
                                                    <?php
                                                    $index++;
...
<script>
    ...
    function createSheet() {
        ...
        // Send AJAX request
        $.ajax({
            url: "<?= base_url() ?>admin/excel/create_new",
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,
