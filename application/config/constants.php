...
define('UNIVERSITY_APPLIED', '18');
define('ADMISSION_LETTER_PENDING', '6');
define('ADMISSION_LETTER_APPLY', '7');
// define('ADMISSION_LETTER_APPLY', '22');
define('ADMISSION_LETTER_RECEIVED', '19');
define('ENTRANCE_EXAM_PENDING', '8');
define('LEGALIZATION_PENDING', '9');
define('LEGALIZATION_COMPLETED', '23');
define('LEGALIZATION_APPLIED', '25');
define('FEES_DEPOSITE_PENDING', '10');
define('FEES_DEPOSITE_COMPLETED', '24');
...
define('CONFORMATION_COMPLETED', '33');
