...
$db['secondary'] = array(
    ...
    'username' => APP_DB_USERNAME, // Replace with the actual username of your secondary database
    'password' => APP_DB_PASSWORD, // Replace with the actual password of your secondary database
