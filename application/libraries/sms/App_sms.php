...
define('SMS_TRIGGER_LEAD_SMS', 'lead_sms');
...
class App_sms
{
    ...
    private function set_default_triggers()
    {
        ...
        $triggers = [
            ...
            SMS_TRIGGER_LEAD_SMS => [
                'merge_fields' => array_merge($customer_merge_fields, $contract_merge_fields),
                'label'        => 'New SMS on Contract(Lead) (to customer)',
                'info'         => 'Trigger when staff member send sms to lead, SMS will be sent customer contacts.',
            ],
