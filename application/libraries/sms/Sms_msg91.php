...
class Sms_msg91 extends App_sms
{
    ...
    private $apiRequestUrl = 'http://sms.wishsolution.com/api/sms/SendSMS.aspx?usr=Affinityedu&key=641C3D3B-AACE-4CCD-AEE7-154CB750F1DA&smstype=TextSMS&rout=Transactional&from=AFNITY';

    //http://sms.wishsolution.com/api/sms/SendSMS.aspx?usr=Affinityedu&key=641C3D3B-AACE-4CCD-AEE7-154CB750F1DA&smstype=TextSMS&to=8505914525&msg=your Affinity OTP is 4004. Please don't share with any one.&rout=Transactional&from=AFNITY&templateid=
